...
if __name__ == '__main__':
    ...
    if args.model == 'cnn':
        ...
        global_model=Logistic(in_dim=60, out_dim=5)
    ...
    # copy weights
    if (args.iid == 0) and args.dataset == 'cifar':
        print("load pre-trained vgg model")
        pre_weights = torch.load("VGG_pretrained.pt")
        global_model.load_state_dict(pre_weights)
    ...
    # torch.save(global_model.state_dict(), "VGG_pretrained.pt")
